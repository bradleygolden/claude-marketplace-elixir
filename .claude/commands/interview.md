---
description: Gather context through interactive questioning to guide Claude Code marketplace workflow execution
...
- Priorities: What matters most (robustness, simplicity, extensibility)?
...
**If user selected "Deep technical dive" + "Hook execution" + "Integration points":**
```
Research Directive: Use analyzer agents to trace complete hook execution flows.
Focus on how hooks trigger, execute scripts, and integrate with Claude Code.
Document each step with file:line references and data transformations.
```

**If user selected "Minimal viable" + "Robustness" + "Follow existing":**
```
Plan Directive: Design should match existing plugin patterns in the marketplace.
Prioritize script reliability and error handling over optimization.
Include testing validation matching existing hook test patterns.
```
...
- Examples:
  - `.thoughts/interview/interview-2025-10-27-pre-research-hook-system.md`
  - `.thoughts/interview/interview-2025-10-27-pre-plan-monitoring-plugin.md`
  - `.thoughts/interview/interview-2025-10-27-pre-implement-test-framework.md`
...
- Formulate 2-6 contextual questions that directly address those decisions
